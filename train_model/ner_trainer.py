...
class NerTrainer:
    """Class to Train the model which will recognize entities"""
    def __init__(
    ...
    def train_model(self):
        ...
        data_collator = DataCollatorForTokenClassification(
            AutoTokenizer.from_pretrained(self.model_ckpt)
        )
    ...
    def get_config(self):
        """Get the config of the dataset and number of labels"""
